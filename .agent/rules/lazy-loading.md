---
description: Lazy Loading patterns using HTMX
globs: ["**/*.cshtml"]
alwaysApply: true
---
...
To optimize performance and defer the loading of heavy components (equivalent to Next.js `dynamic import`), use **HTMX's load trigger**.
