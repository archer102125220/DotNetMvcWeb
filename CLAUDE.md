...
- [inline-styles.md](.claude/rules/inline-styles.md): Inline Styles Policy for Razor
- [razor-htmx-components.md](.claude/rules/razor-htmx-components.md): ViewComponents vs PartialViews
- [lazy-loading.md](.claude/rules/lazy-loading.md): HTMX Lazy Loading UI
