# CSS/SCSS Naming Convention (Modified BEM)
...
- **Multi-Page Reuse**: Define in `wwwroot/css/placeholders/` (or your chosen SCSS root directory) and use `@use`.
